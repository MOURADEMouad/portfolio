...
after:absolute after:inset-0 after:w-[0.125em] after:animate-caret after:bg-white"
          ...
          <p className="max-w-4xl text-center justify-center text-white xl:text-xl md:text-lg sm:text-sm text-md">
            Je suis développeur web full stack spécialisé en React et Laravel.
            J'allie sens du détail en UI et rigueur côté serveur pour créer des
            applications web complètes, scalables et maintenables. J'aime
            transformer des idées en produits tangibles et travailler au sein
